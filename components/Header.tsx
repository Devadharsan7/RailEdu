    ...
    <header className="bg-gray-100 border-b border-gray-200 h-16 fixed top-0 left-64 right-0 z-10">
      <div className="h-full px-6 flex items-center justify-between">
        <div className="flex-1 max-w-2xl">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          <button
            onClick={() => alert('Messages: You have 3 unread messages. This feature will display your message inbox.')}
          ...
          <button
            onClick={() => alert('Notifications: You have 2 new notifications. This feature will display your notification center.')}
